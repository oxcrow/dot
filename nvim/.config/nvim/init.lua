...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "s", builtin.current_buffer_fuzzy_find, { desc = "Fuzzily [s]earch in current buffer" })
...
--]]
	...
	-- xplugins
	{ -- hop.nvim plugin to move around in buffers
		"smoka7/hop.nvim",
		version = "*",
		opts = {
	...
	{ -- auto close pairs of brackets/braces/parenthesis, etc.
		"cohama/lexima.vim",
	},
...
ls.add_snippets("cpp", {
	s("for", { t("for (u32 i = 0; i < "), i(1), t("; i++) {"), t({ "", "\t" }), i(2), t({ "", "" }), t("}") }),
})

vim.api.nvim_create_autocmd("BufRead", {
	pattern = { "*.cc", "*.hh", "*.rs", "*.ml", "*.mli" },
	callback = function()
		-- Conceal
		--vim.cmd("syntax match Normal '_' conceal cchar=-")
		--vim.cmd("set conceallevel=1")
		--vim.cmd("set concealcursor=n")
		--vim.cmd("highlight Conceal guifg=black")
	end,
})
